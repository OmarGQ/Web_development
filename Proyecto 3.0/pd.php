<?php
	...
	if($_SESSION['estado'] == "Autenticado"){
		...
		$pdf->SetXY(15,$y);
		$pdf->Cell(10,10,utf8_decode('La informacion de los productos sea correcta'));
		$y+=10;
		$pdf->SetXY(15,$y);
		$pdf->Cell(10,10,utf8_decode('No se autorizan renbolsos por errores en el pago'));
		$y+=10;
		$pdf->SetXY(15,$y);
		$pdf->Cell(10,10,utf8_decode('Debes esperar a que la operacion del pago sea procesada para autorizar el envio de tu compra'));
		$y+=10;
		$pdf->SetXY(15,$y);
		$pdf->Cell(10,10,utf8_decode('Conserva tu copia para cualquier aclaracion'));
		$y+=20;
